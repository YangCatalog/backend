...
class YangCatalogApiGlobalConfig():
    ...
    def __init__(self):
        ...
        self.result_dir = config.get('Web-Section', 'result-html-dir', fallback='')
        self.private_dir = config.get('Web-Section', 'private-directory', fallback='tests/resources/html/private')
        self.dbHost = config.get('DB-Section', 'host', fallback='')
        ...
        self.save_requests = config.get('Directory-Section', 'save-requests', fallback='tests/resources/cache')
        ...
        self.ip = config.get('Web-Section', 'ip', fallback='yangcatalog.org')
        ...
        self.api_port = int(config.get('Web-Section', 'api-port', fallback=0))
        ...
        self.my_uri = config.get('Web-Section', 'my-uri', fallback='tests/resources/html')
        self.yang_models = config.get('Directory-Section', 'yang-models-dir', fallback='tests/resources/all_modules')
