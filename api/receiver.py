...
class Receiver:
    ...
    def __init__(self, config_path):
        ...
        self.__confd_ip = config.get('General-Section', 'confd-ip')
        self.__confdPort = int(config.get('General-Section', 'confd-port'))
        self.__protocol = config.get('General-Section', 'protocol-api')
        self.__api_ip = config.get('Receiver-Section', 'api-ip')
        self.__api_port = int(config.get('General-Section', 'api-port'))
        self.__api_protocol = config.get('General-Section', 'protocol-api')
        self.__confd_protocol = config.get('General-Section', 'protocol')
        self.__key = config.get('Receiver-Section', 'key')
        self.__notify_indexing = config.get('Receiver-Section', 'notify-index')
        self.__result_dir = config.get('Web-Section', 'result-html-dir')
        self.__save_file_dir = config.get('Directory-Section', 'save-file-dir')
        self.__yang_models = config.get('Directory-Section', 'yang_models_dir')
        ...
        self.__rabbitmq_virtual_host = config.get('RabbitMQ-Section', 'virtual_host', fallback='/')
