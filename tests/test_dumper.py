...
class TestDumperClass(unittest.TestCase):
    ...
    def test_dumper_dump_modules(self):
        ...
        with open(self.resource('test_data.json'), 'r') as f:
            file_content = json.load(f)
        desired_module_data = file_content['dumped_module']['module']
    ...
    def test_dumper_dump_vendors(self):
        ...
        with open(self.resource('test_data.json'), 'r') as f:
            file_content = json.load(f)
        desired_vendor_data = file_content['dumped_vendor_data']['vendors']['vendor']
